...
name: "dsh-market"
description: "DeepSeek Harness 插件市场 · 持续收录 6000+ DSH 插件：中文搜索 + 实用五维评分 + 一键安装。Web 版与 DSH 侧边栏插件双形态。Plugin marketplace for DeepSeek Harness: 6000+ plugins, Chinese search, 5-dim scoring, one-click install."
...
healthScore: 99
undervaluedScore: 34
maintainers: ["2BingLing", "LiPu-jpg", "tr1v3r"]
openGraphImageUrl: "https://opengraph.githubassets.com/9f3de172108c5f4b82975caeab51474c1a129de204cbe0865157e7779ba6599b/2BingLing/dsh-market"
discussionCount: 0
---
...
- **DSH ≥ 0.1.5**（最新发布 `0.1.5-rc.1` 已实测）
- **Node.js ≥ 20**

面板入口自动适配：0.1.5+ 用标准入口（图标进左侧导航栏）；更早版本回退侧栏底部按钮 + 浮层，仍可用但已进入维护模式，**0.5.0 起移除**。
