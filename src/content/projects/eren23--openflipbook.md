...
lastCommitAt: "2026-07-05T06:31:51Z"
status: "thriving"
tags: ["solo_builder"]
healthScore: 89
undervaluedScore: 27
maintainers: ["eren23"]
openGraphImageUrl: "https://opengraph.githubassets.com/b517a512996b3d762cd497124e97fbcdef5dfd93060c564c8691fac085534c5b/eren23/openflipbook"
discussionCount: 0
---
...
Sped up 4×: landing → `"how does a steam engine work"` deeplink → two click-to-explore hops. [Full-quality MP4 with audio](https://github.com/eren23/openflipbook/raw/main/apps/web/public/demo.mp4). Recorded with the Playwright driver under [`scripts/record-demo/`](https://github.com/eren23/openflipbook/blob/HEAD/scripts/record-demo/) — run `pnpm record-demo` to re-capture against your own stack.
...
- **One image per page**, rendered by fal (default balanced tier:…
